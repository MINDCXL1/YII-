...
function listClick(value){
	...
	if(value == 1){
		...
		$("#crowdfunding_iframe").attr("src","index.php?r=user/my_info");
...
$("#listClick19").attr("class","");
	...
	if(value == 2){
		...
		$("#crowdfunding_iframe").attr("src","index.php?r=user/make_head");
...
$("#listClick19").attr("class","");
	...
	if(value == 4){
		...
		$("#crowdfunding_iframe").attr("src","index.php?r=user/make_password");
...
$("#listClick19").attr("class","");
	...
	if(value == 6){
		...
		$("#crowdfunding_iframe").attr("src","index.php?r=user/project_manage");
...
$("#listClick19").attr("class","");
	...
	if(value == 11){
		...
		$("#crowdfunding_iframe").attr("src","index.php?r=user/grade_integration");
...
$("#listClick19").attr("class","");
	...
	if(value == 19){
		...
		$("#crowdfunding_iframe").attr("src","index.php?r=user/addnews");
