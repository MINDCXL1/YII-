...
<div class="sub-wrap mb20">
  <div class="w1024"> 
      <div class="list-dw"><a href="http://www.lynow.cn">今日临沂</a><span>&gt;</span><a href="http://www.lynow.cn/linyi/">临沂</a> > <a href="http://www.lynow.cn/linyi/news/">口碑</a> > </div>
    </div>
</div>
<!--sub-wrap-->
  ...
  <div class="w675 fl"> 
        <ul class="w675 aikan-list mb40"> 
         <?php foreach($model as $model): ?>
               <li class="imgnone"><a href="<?= Url::to(['from/content','id'=>$model['id']]);?>">
                        <div class="fr tent">
                          <h2><?= $model['title'] ?></h2>
        ...
        <div class="w300 mb20">
          ...
          <div class="w300 bjtj">
            ...
            for($i=0;$i<1;$i++)
            {
                echo "
                        <dl class=\"mb10\">
              <dt><a href=".$rows[$i]['url']."><img src=".$rows[$i]['thumb']."></a></dt>
                <dd><a href=".$rows[$i]['url'].">".$rows[$i]['title']."</a></dd> 
            </dl>
                          ";
            }
?>   
            ...
            {
                echo "
                          <li><a href=".$rows[$i]['url'].">".$rows[$i]['title']."</a></li>
                                              ";
            }
?>   
                        </ul> 
